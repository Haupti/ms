...
syn keyword mslBuiltin sys_env process_args sys_exit sys_exec sys_now sys_is_tty sys_has_color 
...
syn keyword mslBuildin fs_exists fs_mkdir fs_rm fs_ls 
syn keyword mslBuiltin file_read file_write file_append
syn keyword mslBuildin math_abs math_floor math_ceil math_round math_sqrt math_pow math_sin math_cos math_tan math_log math_exp
